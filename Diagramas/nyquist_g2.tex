...
\addplot[only marks, mark=+, mark options={}, mark size=2.5000pt, draw=mycolor2, forget plot] table[]{Diagramas/data/nyquist_g2-1.tsv};
...
\addplot[only marks, mark=*, mark options={}, mark size=1.5000pt, draw=mycolor1, fill=mycolor1, forget plot] table[]{Diagramas/data/nyquist_g2-9.tsv};
\addplot[only marks, mark=*, mark options={}, mark size=1.5000pt, draw=mycolor1, fill=mycolor1, forget plot] table[]{Diagramas/data/nyquist_g2-10.tsv};
\end{axis}
\end{tikzpicture}%
